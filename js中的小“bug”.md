...
// true
**2016-12-18补充：**关于浮点数的计算精度问题的说明
1.[0.1+0.2!=0.3](https://www.web-tinker.com/article/20035.html)
2.[0.1+0.2=0.30000000000000004](https://www.zhihu.com/question/28551135)
3.[揭秘0.1+0.2!=0.3](http://www.cnblogs.com/hustskyking/p/ieee754-operation-in-js.html)
总的来说还是浮点数在计算机中的表示问题，这个是无法被解决的，只有避免这样的浮点数比较。
当初是在网站上看到有人用这一点来吐槽JavaScript的不是，现在想想真是可笑，用这样的问题拿来说教，我当初还差点信了！！！
## sort()
...
## 返回值
例子中当返回16位包括16位9组成的数字的时候，都会出现的自动加1的情况，感觉和数值的精度有些关系吧，但是具体情况还没能查阅到相关资料，以后补上。
